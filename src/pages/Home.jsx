...
const Home = () => {
  return (
    <div>
      <img
        alt="Home Background"
        className="block md:hidden absolute top-0 scale-y-150 left-0 z-[-1] w-full min-h-[100vh]"
        src={homeBgMobile}
      />
      <img
        alt="Home Background"
        className="hidden md:block lg:hidden absolute scale-y-125 top-0 left-0 z-[-1] w-full  min-h-[100vh]"
        src={homeBgTablet}
      />
      <img
        alt="Home Background"
