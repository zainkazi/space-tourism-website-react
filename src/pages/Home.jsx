...
// bg-[url('./assets/home/background-home-desktop.jpg')] bg-no-repeat

const Home = () => {
  return (
    <div className="border-4 lg:min-h-[100vh] border-black text-center lg:text-left flex flex-col justify-between items-center lg:flex-row lg:justify-between lg:space-x-52 lg:px-36">
      {/* Intro */}
      <img
